...
class VexorSidebar(Widget):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield Static("[dim]  ⬡[/] [white]Decoder[/] [dim]F8[/]", classes="sidebar-item", id="sidebar-decoder")
        yield Static("[dim]  ⬡[/] [white]Comparer[/] [dim]F9[/]", classes="sidebar-item", id="sidebar-comparer")
        yield Static("[dim]  ⬡[/] [bright_magenta]SpiderFoot[/] [dim]F10[/]", classes="sidebar-item", id="sidebar-osint")
        yield Static("[dim]─────────────────────[/]", classes="sidebar-divider")
