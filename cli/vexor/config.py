...
PAYLOADS_DIR  = Path(__file__).parent / "payloads"   # built-in payloads
...
# ─── Tool info ────────────────────────────────────────────────────────────────
TOOL_NAME        = "Vexor"
TOOL_VERSION     = "4.2.0"   # bumped after this upgrade sprint
...
def ensure_dirs() -> None:
    ...
    # Note: PAYLOADS_DIR is inside the package — not created here
